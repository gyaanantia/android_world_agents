...
# 
# This script creates a clean conda environment with only the necessary dependencies.
# All Python packages are managed through pyproject.toml for consistency.
...
echo "  - TextGrad optimization support"
echo "  - Gemini API integration"
echo "  - All necessary dependencies from pyproject.toml"
echo ""
echo "To activate the environment, run:"
echo "  conda activate android_world"
echo ""
echo "Optional setup commands:"
echo "  # Set up Weights & Biases (if needed):"
echo "  pip install wandb && wandb login"
echo ""
echo "  # Set up Hugging Face access (if needed):"
...
echo "  python -c \"import textgrad; print('TextGrad optimization available')\""
echo "  python tests/test_setup_verification.py  # Comprehensive setup verification"
